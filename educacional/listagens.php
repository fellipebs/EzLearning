                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner" style='height: 600px !important;'>
                                <table>
                                <style>
.dropbtn {
...
<div class="dropdown">
  <button class="dropbtn">Todas listagens disponíveis:</button>
  <div class="dropdown-content">
  <a href="listagemAlunos.php">Listagem de alunos</a>
  <!-- <a href="listagemAtividades.php">Listagem de atividades</a> -->
  <a href="listagemAulas.php">Listagem de aulas</a>
  <a href="listagemTurmas.php">Listagem de turmas</a>
  </div>
</div>
