...
<div class="login-page">
    <div class="form">
        <div class="container">
        <form class="login-form" action='receberalunocadastrado.php' method="post" enctype="multipart/form-data">

            <br></r><input type="text" name ="nome" placeholder="Digite o nome do aluno" required/>
           ...
           <br><button>Cadastrar!</button>
            ...
            <br><p class="message" style='float: left;'><a href="">Voltar</a></p>
        </form>
    </div>
</div>
</div>
