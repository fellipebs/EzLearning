                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <a title="Landing Page" href="relatorios.php" aria-expanded="false"><span class="educate-icon educate-charts icon-wrap"></span> <span class="mini-click-non">Gráficos</span></a>
                        </li>
                        <li>
                        <a title="Landing Page" href="listagens.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Listagens</span></a>
                        </li>
                        <li>
                        <a title="Landing Page" href="cadastroAluno.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Cadastro de Aluno</span></a>
                        </li>
                        <li>
                        <a title="Landing Page" href="cadastroProfessor.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Cadastro de Professor</span></a>
                        </li>
                        <li>
                        <a title="Landing Page" href="CadastroTurma.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Cadastro de Turma</span></a>
                        </li>
                        <li>
                        <a title="Landing Page" href="CadastroUsuario.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap"></span> <span class="mini-click-non">Cadastro de Usuario</span></a>
                        </li>
                        <!-- <li>
